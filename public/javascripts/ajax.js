...
/***/ function(module, exports, __webpack_require__) {
			...
			return regeneratorRuntime.wrap(function _callee2$(_context2) {
				while (1) {
					switch (_context2.prev = _context2.next) {
						case 0:
							options.method = "GET";
							return _context2.abrupt("return", exports.ajax(url, options));
				...
				while (1) {
					switch (_context3.prev = _context3.next) {
						case 0:
							...
							return _context3.abrupt("return", exports.ajax(url, options));
	...
	document.getElementById("sub").onclick = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
		var data;
